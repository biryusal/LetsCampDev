import { APPLY_FILTERS_FAILURE, APPLY_FILTERS_REDIRECT, APPLY_FILTERS_REQUEST, APPLY_FILTERS_SUCCESS, CHANGE_FILTERS, GET_AMOUNT_OF_CAMPINGS_FAILURE,
   GET_AMOUNT_OF_CAMPINGS_REQUEST, GET_AMOUNT_OF_CAMPINGS_SUCCESS, GET_CAMPINGS_BY_PAGEID_FAILURE, GET_CAMPINGS_BY_PAGEID_REQUEST, GET_CAMPINGS_BY_PAGEID_SUCCESS, 
   GET_CAMPING_BY_ID_FAILURE, GET_CAMPING_BY_ID_REQUEST, GET_CAMPING_BY_ID_SUCCESS, GET_FILTERED_CAMPINGS_BY_PAGEID_FAILURE, GET_FILTERED_CAMPINGS_BY_PAGEID_REQUEST, 
   GET_FILTERED_CAMPINGS_BY_PAGEID_SUCCESS, RESET_FILTERS_REDIRECT, REVOKE_ADDITIONAL_FILTERS, REVOKE_SPECIAL_FILTERS, SET_SELECTED_REGION, 
   SET_SELECT_GUESTS_OUTPUT, UPDATE_AMOUNT_OF_CAMPINGS } from "../types/types";
...
export default function CampingsReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case SET_SELECT_GUESTS_OUTPUT:
      return {...state, selectedGuestsOutput: action.payload}
    default:
      return state;
  }
}
